...
- [No server code implementation](https://docs.adapty.io/docs/android-sdk-configuration?utm_source=github&utm_medium=referral&utm_campaign=AdaptySDK-Android). Integrate in-app purchases with server-side receipt validation in minutes. Apple Promotional Offers supported out-of-the-box.
