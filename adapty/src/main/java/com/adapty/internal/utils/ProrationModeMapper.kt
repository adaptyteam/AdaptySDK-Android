...
import com.adapty.models.AdaptySubscriptionUpdateParameters.ProrationMode.*
...
internal class ProrationModeMapper {
    ...
    @JvmSynthetic
    fun map(prorationMode: AdaptySubscriptionUpdateParameters.ProrationMode) = when (prorationMode) {
