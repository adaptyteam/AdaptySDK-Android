 ...
 * @property[appliedExternalAttributionProviders] External attribution providers whose data has been
 * processed by the backend and is used for profile segmentation.
...
public class AdaptyProfile internal constructor(
    ...
    public val appliedExternalAttributionProviders: ImmutableList<AdaptyExternalAttributionProvider>,
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + appliedExternalAttributionProviders.hashCode()
        return result
    }

    override fun toString(): String {
        return "AdaptyProfile(profileId=$profileId, customerUserId=$customerUserId, accessLevels=$accessLevels, subscriptions=$subscriptions, nonSubscriptions=$nonSubscriptions, customAttributes=$customAttributes, appliedExternalAttributionProviders=$appliedExternalAttributionProviders)"
    }
